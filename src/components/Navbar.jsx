          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-3 sm:py-2.5">
            ...
            <div className="flex items-center justify-between w-full sm:w-auto">
              ...
              <ResponsiveImage
                ...
                alt="Adeel Mukhtar"
                containerClassName="w-7 h-7 sm:w-8 sm:h-8 lg:w-10 lg:h-10 rounded-full border-2 border-cyan-300/50 hover:border-accent transition-all duration-300 shadow-md cursor-pointer"
